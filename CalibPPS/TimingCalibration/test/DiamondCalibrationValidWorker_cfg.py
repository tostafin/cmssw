...
options.register('tVsLsFileName',
                ...
                VarParsing.VarParsing.multiplicity.singleton,
                VarParsing.VarParsing.varType.string,
                "ROOT file with t vs LS")

options.parseArguments()

process.worker = DQMEDAnalyzer('PPSTimingCalibrationPCLValidWorker',
                               tVsLsFileName=cms.untracked.string(options.tVsLsFileName))
...
process.load("CalibPPS.TimingCalibration.ppsTimingCalibrationPCLValidWorker_cfi")
process.DQMStore = cms.Service("DQMStore")

process.dqmOutput = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string("file:worker_valid_output.root"),
    outputCommands = cms.untracked.vstring(
    'drop *',
    'keep *_MEtoEDMConvertPPSTimingCalib_*_*',
    ))

process.load("CalibPPS.TimingCalibration.ALCARECOPromptCalibProdPPSValidTimingCalib_cff")
...
process.path = cms.Path(
    ...
    #process.recoCTPPS *
    process.ppsTimingCalibrationPCLValidWorker *
