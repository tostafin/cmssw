...
# ^^^^^^^^^^^^^^^^^^^^^^^^^
tagDigi_ =  cms.InputTag("ctppsDiamondRawToDigiAlCaRecoProducer", "TimingDiamond"),
...
if(options.calibInput != ''):
    ...
    process.diamondTimingWorker = DQMEDAnalyzer("DiamondTimingWorker",
            ...
            tagPixelLocalTrack = cms.InputTag("ctppsPixelLocalTracksAlCaRecoProducer"), # TODO: this is differnt that calib check this
