...
process.hltOutputALCAPPS = cms.OutputModule( "PoolOutputModule",
  ...
  'HLT_PPSMaxTracksPerRP4_v1' ) ),
    outputCommands = cms.untracked.vstring( "keep *_hltPPSExpCalibrationRaw_*_*", "keep *_hltPPSPrCalibrationRaw_*_*", "keep GlobalObjectMapRecord_hltGtStage2ObjectMap_*_*", "keep edmTriggerResults_*_*_*", "keep triggerTriggerEvent_*_*_*" )
)
...
_customInfo['inputFile' ]=  ['/store/data/Run2018D/ZeroBias/RAW/v1/000/322/022/00000/26EC8215-9AAD-E811-93AC-FA163E0B94D5.root']
