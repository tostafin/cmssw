...
optics_2023 = cms.PSet(
  validityRange = cms.EventRange("343890:min - 370790:max"),

  opticalFunctions = cms.VPSet(
    cms.PSet( xangle = cms.double(135.000), fileName = cms.FileInPath("SimPPS/DirectSimProducer/data/135.000urad_calib.root") ),
    cms.PSet( xangle = cms.double(144.974), fileName = cms.FileInPath("SimPPS/DirectSimProducer/data/144.974urad_calib.root") ),
    cms.PSet( xangle = cms.double(160.000), fileName = cms.FileInPath("SimPPS/DirectSimProducer/data/160.000urad_calib.root") )
  ),
