#!/bin/bash
mkdir DQMRun2_$1$2
cp /afs/cern.ch/user/n/nminafra/Work/CMSSW/DataReduction/CMSSW_9_2_0_patch2/src/sendDQMJob.sh DQMRun2_$1$2/
cp /afs/cern.ch/user/n/nminafra/Work/CMSSW/DataReduction/CMSSW_9_2_0_patch2/src/list_of_datGR.py DQMRun2_$1$2/
cp /afs/cern.ch/user/n/nminafra/Work/CMSSW/DataReduction/CMSSW_9_2_0_patch2/src/dqm_run.py DQMRun2_$1$2/
cd DQMRun2_$1$2
