...
process.output = cms.OutputModule("PoolOutputModule",
        fileName = cms.untracked.string("file:output-miniDaq2303-T2testFile1-Sun19Mar-sampic-printDebug7-noIDtest-sampicNotParallelProcessing-T2DigiPrint-hwID-eqOrPlus1-5ev.root"),
