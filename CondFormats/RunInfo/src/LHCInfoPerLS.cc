...
//setters
void LHCInfoPerLS::setFillNumber(unsigned short const& lhcFill) {  LHCInfoPerLS::setOneParam(m_intParams, LHC_FILL, static_cast<unsigned int>(lhcFill)); }
...
void LHCInfoPerLS::setRunNumber(cond::Time_t const& runNumber) { LHCInfoPerLS::setOneParam(m_timeParams, RUN_NUMBER, runNumber); };
