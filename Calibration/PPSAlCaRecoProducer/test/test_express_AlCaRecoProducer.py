...
process.load('Calibration.PPSAlCaRecoProducer.ALCARECOPPSCalMaxTracksExpress_cff') 
process.load('Calibration.PPSAlCaRecoProducer.ALCARECOPPSCalMaxTracksExpress_Output_cff') 
...
process.recoOutputALCAPPS = cms.OutputModule( 'PoolOutputModule',
    ...
    outputCommands = process.OutALCARECOPPSCalMaxTracksExpress_noDrop.outputCommands
)

process.reco = cms.Path( process.seqALCARECOPPSCalMaxTracksRecoExpress )
