...
# with command line options: step2 -s L1Reco,ALCAPRODUCER:PPSCalMaxTracksExpress,ENDJOB --process ALCARECO --scenario pp --era ctpps_2018 --conditions auto:run3_data_express --data --datatier ALCARECO --eventcontent ALCARECO -n 100 --filein file:/eos/project-c/ctpps/subsystems/Software/Off-line/AlCaTest/outputALCAPPS_single.root --fileout file:step2.root
...
# Other statements
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOPPSCalMaxTracksExpress_noDrop.outputCommands)
...
# Schedule definition
process.schedule = cms.Schedule(process.L1Reco_step,process.pathALCARECOPPSCalMaxTracksExpress,process.endjob_step,process.ALCARECOoutput_step)
