...
process.load("CalibPPS.TimingCalibration.ppsTimingCalibrationPCLValidHarvester_cfi")
#process.PPSDiamondSampicTimingCalibrationPCLHarvester.jsonCalibFile="initial.cal.json"

# load DQM framework
process.load("DQMServices.Core.DQMStore_cfi")
process.load("DQMServices.Components.DQMEnvironment_cfi")
process.dqmEnv.subSystemFolder = "ValidCalibPPS"
...
process.dqmOutput = cms.OutputModule("DQMRootOutputModule",
    fileName = cms.untracked.string("harvester_valid_output.root")
)
...
process.p = cms.Path(
    ...
    process.ppsTimingCalibrationPCLValidHarvester
)
